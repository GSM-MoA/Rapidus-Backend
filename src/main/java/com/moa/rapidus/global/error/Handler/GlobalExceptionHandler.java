package com.moa.rapidus.global.error.Handler;

import com.moa.rapidus.global.error.ErrorMessage;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleComprehensiveException(HttpServletRequest request, GlobalException e) {
